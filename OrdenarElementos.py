...
import ctypes
myappid = 'rafael.ordenar.ordalgoritmos.1.0'
...
class Ui_Ordenar_Elementos(object):
    def setupUi(self, Ordenar_Elementos):
        ...
        self.heapButton.setGeometry(QtCore.QRect(270, 10, 84, 20))
        self.heapButton.setObjectName("heapButton")
        self.shellButton = QtWidgets.QRadioButton(self.groupBox)
        self.shellButton.setGeometry(QtCore.QRect(100, 10, 83, 20))
        ...
        self.ascButton.setGeometry(QtCore.QRect(90, 20, 93, 20))
        ...
        self.descButton.setGeometry(QtCore.QRect(90, 50, 100, 20))
    ...
    def ordenar(self):
        ...
        self.alg = {0: "shellSort.exe", 1: "heapSort.exe"}
